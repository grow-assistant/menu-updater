...
def handle_operation_step(operation: Dict[str, Any], message: str) -> Dict[str, Any]:
    ...
    if operation["current_step"] >= len(operation["steps"]):
        return {
            "role": "assistant",
            "content": "I didn't understand that command. Please try again.",
        }
    ...
    if step == "confirm_items":
        ...
        try:
            ...
            return {"role": "assistant", "content": confirmation_msg}
...
def store_operation_history(
    settings: Dict[str, Any], operation: Dict[str, Any], result: Dict[str, Any]
) -> Dict[str, Any]:
